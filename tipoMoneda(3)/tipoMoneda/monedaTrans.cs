...
namespace tipoMoneda
{
    public partial class Tipo : Form
    {
         ...
         try
            {
                ...
                cmd = new OdbcCommand("INSERT INTO moneda (idMoneda,moneda,valor,Fecha) VALUES ('" + txtid.Text + "', '" + cmbtipo.Text + "' , '" + txtval.Text + "','" + fecha.ToString()+ "'); ", cn);
             cmd.ExecuteNonQuery();
                txtid.Text = "";
                txtval.Text = "";
        ...
        public void mostrar()
        {
            ...
            da = new OdbcDataAdapter("select idMoneda as Id, moneda as Tipo, valor as Valor, Fecha as Fecha from moneda;",cn);
            dt = new DataTable();
            da.Fill(dt);
        ...
        private void btnactualizar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                cmd = new OdbcCommand("UPDATE moneda set moneda ='" + cmbtipo.Text + "', valor ='" + txtval.Text + "', Fecha='"+ fecha.ToString()+"' where idMoneda= '" + txtid.Text + "' ", cn);
                cmd.ExecuteNonQuery();
        ...
        {
            monedaMaster frm = new monedaMaster();
            frm.Show();
        }
    }
}
